...
At this point in time, I prefer vim because I would like to learn to use an editor that will be really useful once I become comfortable with it and because it is often the default.
...
I have chosen to use Atom because I like the idea of getting familiar with a graphical editor that has open architecture (and based on the recommendation of the TA).
